...
public class IdentityAuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest arg0, ServletResponse arg1, FilterChain chain) throws IOException, ServletException {
        ...
        if (!StringUtil.isNullOrEmpty(wxtoken)) {

            criteria.put("wxtoken", wxtoken);
...
/*                //已经登录则清理session
        ...
        if (!StringUtil.isNullOrEmpty(platformUser)) {
            ...
            if (urlfilter) {
                ...
                if (wxtoken.equals(platformUser.getMobiletoken())) {
                    chain.doFilter(arg0, arg1);
                } else {
