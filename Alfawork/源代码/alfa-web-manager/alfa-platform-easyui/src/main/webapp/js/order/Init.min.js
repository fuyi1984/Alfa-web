...
}}]})}function Accesscontrol(){switch(groleid){case 9:$("#btnSave").linkbutton("disable");$("#btnAllocating").linkbutton("disable");$("#btnDelete").linkbutton("disable");$("#btnSearch").linkbutton("disable");break;case 10:$("#btnAllocating").linkbutton("disable");$("#btnDelete").linkbutton("disable");$("#btnSearch").linkbutton("disable");$("#btnConfirm").linkbutton("disable")}};